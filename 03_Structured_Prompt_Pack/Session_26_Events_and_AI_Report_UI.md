...
## Goal
Expose deterministic rule events first, then bounded AI reports that never claim unavailable/unmeasured variables.
...
web/app/events/**, web/app/reports/**, API/report integration

## Implementation prompt
Implement only Session 26: **Events and AI Report UI**. Reuse the existing repository and preserve all completed earlier work. Do not perform later sessions. Keep the system safe, reproducible, and evidence-driven. The web facade must distinguish current, stale, missing, optional, manual, and unavailable data rather than inventing values.
...
- [ ] Evidence saved under `evidence/S26/`.
...
## Commit message
`feat: add event history and bounded AI reports`

## Stop condition
Stop after Session 26 acceptance is recorded. Do not auto-run Session 27.
